...
class PriorityQueueWithFunction(PriorityQueue):
    ...
    #def removeStateIfHeuris(self, position,heuristics):
    #    """
    #    This method is used especially for A* algorithm next state insertion
    #    """
    #    for x in range(0,len(self.heap)):
    #        if self.heap[x].position==position:
    #            if self.heap[x].heuristic<heuristics:
    #                return
    #            else:
    #                self.heap.remove(x)
    #y                return
