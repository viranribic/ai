from blaze.expr.arithmetic import Ne
...
if __name__ == '__main__':
    ...
    mutationProbability  = .4 # Probability of mutation
    #mutationScale = 5. # Standard deviation of the gaussian noise
    mutationScale = 100. # Standard deviation of the gaussian noise
